    ...
    <div class="w-full">
        <div class=" sm:grid sm:grid-cols-12">
            ...
            <ul class="sm:col-span-6">
                ...
                <input @keyup="searchActors()" v-model="searchKeyActor" type="text" class="w-full rounded-md h-8 px-2  sm:h-9 text-black   outline-none" placeholder="Search Actors">
                </div>
                <li>
                    <InArticleAdsVue/>
                </li>
                <li v-for="(actor, index) in actors" class="px-3 hover:bg-slate-500 cursor-pointer border-b border-gray-600"
                    :key="index">
